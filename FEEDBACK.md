...
- Use a template for the README file as soon as you create the repository. This way you will be able to edit it / iterate on it as you work on the project. Use Christine Jiang's first video feedback [as a reference](https://youtu.be/UddfFCI70iw?t=1885) for what works.   

P.S. More specific feedback in the `data-cleaning-pandas-feedback.ipynb` notebook!